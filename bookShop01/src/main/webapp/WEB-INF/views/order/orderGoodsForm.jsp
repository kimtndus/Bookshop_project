...
<form  name="form_order">	
	...
	<br>
	<table width=80% class="list_view" style="background: #7986CB; color:white; font-weight: bold;">
		<tbody>
			...
			<tr cellpadding=40 align=center>
				...
				<td><IMG width="25" alt=""
					src="${pageContext.request.contextPath}/resources/image/plus.png"></td>
				<td>
					<p id="p_totalDelivery">${total_delivery_price }원</p> <input
					id="h_totalDelivery" type="hidden" value="${total_delivery_price}" />
				</td>
				<td>
				<img width="25" alt="" 	src="${pageContext.request.contextPath}/resources/image/minus.png"></td>
				<td>
					<p id="p_totalSalesPrice">${total_discount_price }원</p> 
					<input id="h_total_sales_price" type="hidden" value="${total_discount_price}" />
				</td>
				<td><img width="25" alt="" src="${pageContext.request.contextPath}/resources/image/equal.png"></td>
				<td>
			...
			<table>
				<tbody align=center>
				   ...
				   <tr>
				    ...
				    <button type="button" name="btn_process_pay_order" class="btn btn-outline-primary" onClick="fn_process_pay_order()" value="최종결제하기">최종결제하기</button>
