...
<!-- 					  <input type="button" value="수정하기" onClick="fn_modify_member_info('member_pw')" /> -->
  						<button type="button" class="btn btn-outline-secondary" onClick="fn_modify_member_info('member_pw')">수정하기</button>
...
<!-- 					  <input type="button" value="수정하기" onClick="fn_modify_member_info('member_birth')" />-->					  
  						<button type="button" class="btn btn-outline-secondary" onClick="fn_modify_member_info('member_birth')">수정하기</button>
...
<!-- 					  <input type="button" value="수정하기" onClick="fn_modify_member_info('tel')" /> -->
					<button type="button" class="btn btn-outline-secondary" onClick="fn_modify_member_info('tel')">수정하기</button>
					</td>
				</tr>
				<tr class="dot_line">
					   ...
					   <c:when test="${memberInfo.smssts_yn=='true' }">
						...
						<c:otherwise>
						  <div class="form-check form-switch">
								  ...
								  <label class="form-check-label" for="flexSwitchCheckDefault">쇼핑몰에서 발송하는 SMS 소식을 수신합니다.</label>
							</div> 
						</c:otherwise>
					 </c:choose>	
				    </td>
				...
				<tr class="dot_line">
					...
					<c:choose> 
					   <c:when test="${memberInfo.emailsts_yn=='true' }">
					  		 ...
					  		 <div class="form-check form-switch">
								  <input name="emailsts_yn" value="Y" class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault">
