...
<body>
	...
	<div id="detail_table">
		...
		<ul>
			...
			<button type="button" class="buy btn btn-outline-success"
				onclick="fn_order_each_goods('${goods.goods_id }','${goods.goods_title }','${goods.goods_sales_price}','${goods.goods_fileName}');">구매하기</button>
			&nbsp;&nbsp;&nbsp;
			<button type="button" class="cart btn btn-outline-primary"
				onclick="add_cart('${goods.goods_id }')">장바구니</button>
			&nbsp;&nbsp;&nbsp;
	...
	<div id="layer" style="visibility: hidden">
		...
		<div id="popup">
			...
			</a> <br /> <font size="4" id="contents">장바구니에 담았습니다.</font><br>
